...
| unstable | Latest unstable release (from `develop` branch)                                                   | node:18.7.0-bullseye   | 0.32.1           | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-markdownlint/unstable?style=flat-square) |
