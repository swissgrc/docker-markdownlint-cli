...
| unstable | Latest unstable release (from `develop` branch)                                                   | node:20.6.0-bookworm-slim  | 0.36.0           | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-markdownlint/unstable?style=flat-square) |
