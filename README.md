...
| unstable | Latest unstable release (from `develop` branch)                                                   | node:18.16.0-bullseye-slim | 0.33.0           | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-markdownlint/unstable?style=flat-square) |
